...
export default function MarySec() {
  return (
    <>
      <section className="hidden md:block w-full py-12 md:py-24 lg:py-32">
...
getBeforeInit={(instance) => {
    instance.type(" Nesse jogo, ao invés de seguir o detetive, você é o detetive").pause(750).delete(19).pause(500).type(". VOCÊ É O DETETIVE! Investigue tudo tirando suas próprias decisões sobre o caso do massacre cometido no bar").pause(1200).delete(3).pause(500).type("  BallRoom, descubra a motivação do assassino e ache uma solução pra esse caso!")
      ...
      <section className="block  md:hidden w-full py-12 md:py-24 lg:py-32">
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-6">
          ...
          <div className="flex flex-col items-start justify-center space-y-4">
            ...
            >
              <p className="text-muted-foreground md:text-xl lg:text-lg text-white">
                Nesse jogo, ao invés de seguir um detetive VOCÊ É O DETETIVE,
                investigue tudo tirando suas próprias decisões sobre o caso de
