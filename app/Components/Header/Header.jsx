            ...
            <div className="flex items-center">
             ...
             <div className="hidden md:block">
                <div className="ml-4 fkex items-center space-x-4 ">
                    ...
                    <a href="https://www.youtube.com/@pinstergms" target="_blank" className="text-white hover:bg-white hover:text-black rounded-lg p-2">
                        Youtube
                    </a>
                    <a href="https://discord.gg/MAJBHKXAHH" target="_blank" className="text-white hover:bg-white hover:text-black rounded-lg p-2">
                        Discord
                    </a>
                    <Link href="/Games" className="text-white hover:bg-red-600 hover:p-3 hover:shadow-[0px_3px_20px_5px_#f7fafc] hover:text-black rounded-lg p-2">
                        Games
                    </Link>
