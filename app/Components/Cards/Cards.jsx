...
export default function Cards() {
  ...
  return (
    <>
      <main id="cards" className=" bg-black shadow-[inset_0px_0px_30px_8px_#000] z-10 p-12 ">
        ...
        <div className="md:mt-4 w-full h-1 bg-gradient-to-r from-black via-red-600  via-red-600 via-red-600 to-black"></div>
      </main>
    </>
  );
}
