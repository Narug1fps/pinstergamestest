...
export default function Cards() {
	return (
		<>
			<main className=" bg-black shadow-[inset_0px_0px_30px_8px_#000] z-10 p-12 ">
					...
					<div className="  grid grid-cols-1 gap-5 md:grid-cols-2 lg:grid-cols-3">
						...
						<div className="border-2 rounded-2xl group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
							...
							<div className="absolute inset-0 flex translate-y-[60%] flex-col items-center justify-center px-9 text-center transition-all duration-500 group-hover:translate-y-0">
								...
								<p className="mb-3 text-lg italic text-white opacity-0 transition-opacity duration-300 group-hover:opacity-100">
									Nos siga no instagram para ver todos os conteúdos sobre Mary e
									Jogos
								</p>
								<button className="rounded-full bg-neutral-900 py-2 px-3.5 font-com text-sm capitalize text-white shadow shadow-black/60 hover:bg-white hover:text-black">
									<a
						...
						<div className=" border-white border-2  rounded-2xl group relative cursor-pointer items-center justify-center overflow-hidden transition-shadow hover:shadow-xl hover:shadow-black/30">
							<div className="h-96 w-72">
								<Image
									width={288}
									height={384}
